...
=== Options
 ...
 callback:
    default: null
    Override the default AJAX loading behaviour with a custom function, called when the bottom of the page is reached. 
    Function must itself take a callback as an argument, which it should call on completion.
